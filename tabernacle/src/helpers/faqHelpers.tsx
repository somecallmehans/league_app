...
import { getStoreSlug } from "./helpers";
...
export const faqInfo = [
  {
    ...
    Component: () => {
      ...
      if (!roundDay && !roundOneStart && !roundTwoStart) {
        return (
          <div className="py-2">
            <p className="mb-2">
              Each league begins the first week of a given month and repeats
              weekly. Check with your LGS for the specific date and time their
              league runs!
            </p>
            <p className="mb-2">
              Pod assignments for round one are random. In round two, pod
              assignments are ranked by league standings: players with the most
              points are grouped together, as are players with the fewest
              points.
            </p>
            <p className="mb-2">
              Each round, after 90 minutes, “sudden death” ensues. As the next
              turn begins, each player plays one more turn. If the game is not
              over, it is a draw.
            </p>
          </div>
        );
      ...
      return (
        <div className="py-2">
          ...
          <p className="mb-2">
            Each week, round one begins at {roundOneStart}pm, and round two at{" "}
            {roundTwoStart}pm. Pod assignments for round one are random. In
            round two, pod assignments are ranked by league standings: players
            with the most points are grouped together, as are players with the
            fewest points.
          </p>
          <p className="mb-2">
            Each round, after 90 minutes, “sudden death” ensues. As the next
  ...
  },
  {
    ...
    Component: () => {
      ...
      const url = storeSlug
        ? "https://" + storeSlug + ".commanderleague.xyz/achievements"
        : "https://commanderleague.xyz/achievements";
      return (
        <div className="py-2">
          <p className="mb-2">
          ...
          <p className="mb-2">
            Points aren't just awarded for deck building! Additional
            achievements may be earned by bringing a snack to share, sharing
            your decklist on our discord channel, lending decks to other
            players, and more. Learn everything there is to know on our
            <a className="text-sky-500 hover:text-sky-300" href={url}>
              {" "}
              achievement's page
            </a>
          </p>
  ...
  },
  {
    ...
    Component: () => (
      <div className="py-2">
        ...
        <p>
          Stop by during league or reach out to{" "}
          <a
            className="text-sky-500 hover:text-sky-300"
          ...
          . He will add you to the database for your preferred shop and provide
          a unique code you can use to log in on this website (see #2 above).
        </p>
      </div>
    ),
  },
  {
    ...
    Component: () => (
      <div className="py-2">
        <p className="mb-2">
          Players must purchase one booster pack from the host store for each
    ...
    Component: () => (
      <div className="py-2">
        <p className="mb-2">
          ...
          Lively discussion about the league continues on league discord
          channels and every effort is made to integrate community feedback.
        </p>
      </div>
    ),
  },
